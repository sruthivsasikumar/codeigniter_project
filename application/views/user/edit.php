...
<div class="container">  
	<div class="row"> 
		...
		<?php echo form_open('userUpdate/'.$user->user_id);?>
			...
			<div class="form-group">
				...
				<input type="password" name="password" class="form-control"  required><span><h6>The Password field must be at least 5 characters in length</h6></span>
